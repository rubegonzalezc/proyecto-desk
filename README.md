...
Qué sí está implementado en el front (y qué solo dura la pestaña): [`docs/FEATURES.md`](./docs/FEATURES.md).  
Qué se va a añadir ahora: [`docs/ROADMAP.md`](./docs/ROADMAP.md) (Iniciativa 1).
...
| [`docs/ROADMAP.md`](./docs/ROADMAP.md) | Plan vigente: Iniciativa 1 (front mock) |
