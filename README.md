...
Qué se va a añadir ahora: [`docs/ROADMAP.md`](./docs/ROADMAP.md) (épica **Mesa de ayuda IT lista para backend**, sprints 1–5).
...
| [`docs/ROADMAP.md`](./docs/ROADMAP.md) | Plan vigente: épica Mesa de ayuda IT lista para backend (sprints 1–5) |
| [`docs/ROADMAP-historico.md`](./docs/ROADMAP-historico.md) | Archivo del ciclo anterior hacia Supabase |
