...
| **Dirigido a** | Desarrollador responsable |
...
| ID | Título | Dirigido a | Complejidad | Prioridad |
|----|--------|------------|-------------|-----------|
| HU-1 | Aislar datos mock por tenant | **Rubén** | 8/10 | Alta |
| HU-2 | Persistir tenant activo y recientes | **José** | 4/10 | Alta |
| HU-3 | Configuración completa en sesión | **Sebastián** | 3/10 | Media |
| HU-4 | Store de usuarios en sesión | **Rubén** | 6/10 | Alta |
| HU-5 | Invitar usuario añade fila | **Sebastián** | 4/10 | Alta |
| HU-6 | Crear y guardar rol en sesión | **Sebastián** | 5/10 | Alta |
| HU-7 | Movimiento de inventario actualiza stock | **Rubén** | 7/10 | Alta |
| HU-8 | Cmd+K busca conocimiento e inventario | **José** | 5/10 | Media |
| HU-9 | Pestañas persistentes y vacíos al cambiar tenant | **José** | 4/10 | Media |
...
### I1·HU-1 — Aislar datos mock por tenant
...
**Iniciativa:** 1 · **Estado:** Pendiente · **Prioridad:** Alta · **Complejidad:** 8/10 · **Dirigido a:** Rubén  
**Depende de:** —

Por qué Rubén: define el contrato de datos y toca `lib/api`, tipos y stores. Bloquea al resto.

---

### I1·HU-2 — Persistir tenant activo y recientes
...
**Iniciativa:** 1 · **Estado:** Pendiente · **Prioridad:** Alta · **Complejidad:** 4/10 · **Dirigido a:** José  
**Depende de:** —

Por qué José: es cromo de header/`TenantSwitcher`, el mismo tipo de UI que ya mantiene. Puede ir en paralelo a HU-1.

---

### I1·HU-3 — Configuración completa en sesión
...
**Iniciativa:** 1 · **Estado:** Pendiente · **Prioridad:** Media · **Complejidad:** 3/10 · **Dirigido a:** Sebastián  
**Depende de:** —

Por qué Sebastián: extiende el formulario de settings que ya existe; alcance acotado para fullstack junior. En paralelo a HU-1.

---

### I1·HU-4 — Store de usuarios en sesión
...
**Iniciativa:** 1 · **Estado:** Pendiente · **Prioridad:** Alta · **Complejidad:** 6/10 · **Dirigido a:** Rubén  
**Depende de:** HU-1

Por qué Rubén: mismo patrón de arquitectura que `TicketsProvider`. Sebastián no debería inventar un segundo modelo de store.

---

### I1·HU-5 — Invitar usuario añade fila
...
**Iniciativa:** 1 · **Estado:** Pendiente · **Prioridad:** Alta · **Complejidad:** 4/10 · **Dirigido a:** Sebastián  
**Depende de:** HU-4

Por qué Sebastián: modal y validación de formulario, sobre el store que deja Rubén. Pair si hace falta.

---

### I1·HU-6 — Crear y guardar rol en sesión
...
**Iniciativa:** 1 · **Estado:** Pendiente · **Prioridad:** Alta · **Complejidad:** 5/10 · **Dirigido a:** Sebastián  
**Depende de:** HU-1

Por qué Sebastián: formularios y listado, complejidad media. Puede copiar el patrón del store de tickets/usuarios; Rubén revisa el PR de arquitectura ligera.

---

### I1·HU-7 — Movimiento de inventario actualiza stock
...
**Iniciativa:** 1 · **Estado:** Pendiente · **Prioridad:** Alta · **Complejidad:** 7/10 · **Dirigido a:** Rubén  
**Depende de:** HU-1

Por qué Rubén: lógica de negocio en `inventory-store`, fácil de romper el dashboard si queda a medias.

---

### I1·HU-8 — Cmd+K busca conocimiento e inventario
...
**Iniciativa:** 1 · **Estado:** Pendiente · **Prioridad:** Media · **Complejidad:** 5/10 · **Dirigido a:** José  
**Depende de:** HU-1

Por qué José: es dueño de Cmd+K y del header. Trabajo de UI/búsqueda, no de modelo.

---

### I1·HU-9 — Pestañas persistentes y vacíos al cambiar tenant
...
**Iniciativa:** 1 · **Estado:** Pendiente · **Prioridad:** Media · **Complejidad:** 4/10 · **Dirigido a:** José  
**Depende de:** HU-1, HU-2

Por qué José: shell, pestañas y empty states; su foco de frontend junior.
