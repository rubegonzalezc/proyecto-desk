...
| Campo | Descripción |
|-------|-------------|
| **ID** | `I1·HU-N` — Iniciativa 1, historia N (orden secuencial) |
| **Depende de** | `HU-N` dentro de la iniciativa |
| **Prioridad** | Alta · Media · Baja |
| **Asignado a** | Desarrollador responsable (también en el **título** y la cabecera de cada HU) |
...
|---------|-----|---------------------------|
| **Rubén** | Fullstack senior | Modelo de datos, stores, `tenantId`, lógica de stock. HUs bloqueantes. Único que mergea PRs |
...
En orden secuencial (**HU-1 … HU-9**). Cada historia lleva **asignado y rol** en el título y en la cabecera.
...
Día 4–5   José → HU-8 + HU-9          │  Rubén → review y merge de PRs
```
