...
> **No forma parte del plan vigente.** El trabajo actual es la Iniciativa 1 ([`ROADMAP.md`](./ROADMAP.md)), solo front mock. Este contrato se conserva para un ciclo posterior.
